...
public class CustomClockLinear extends LinearLayout {
    ...
    void init() {
        if (isInEditMode()) {
            ...
            mTimeZoneModel.setCalendar(Calendar.getInstance());
            mTimeZoneModel.setTimeZoneId("");
        }
        ...
        if (fonts.isEmpty()) {
            ...
            tf = Typeface.createFromAsset(mContext.getAssets(), "fonts/Roboto-Medium.ttf");
            ...
            tf = Typeface.createFromAsset(mContext.getAssets(), "fonts/Clockopia.ttf");
    ...
    private void updateTime() {
        ...
        customHolder.mAmPm.setShowAmPm(mFormat.equals(m12));
